...
# normally the below should print the value of the password and username on the console, however terraform will never print sensitive info on the console, even though it has access to it.
# output "db_username" {
